...
class PendingConfirmation(OpenHandsModel):
    ...
    expires_at: datetime | None = Field(
        default=None,
        description="Confirmation expiration time"
    )
    callback_message_id: int | None = Field(
        default=None,
        description="Telegram message ID for the confirmation request"
    )
...
class ConfirmationStore(ABC):
    ...
    @abstractmethod
    async def get_confirmation(self, confirmation_id: str) -> PendingConfirmation | None:
